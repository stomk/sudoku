...
class UnitTest < Test::Unit::TestCase
  ...
  test "set_cell" do
    ...
    new_matrix = set_cell(matrix, 1, 2, 1)
    assert_equal "014300209005009001070060043006002087190007400050083000600000105003508690042910300", new_matrix

    # Original matrix should not be changed
    assert_equal "004300209005009001070060043006002087190007400050083000600000105003508690042910300", matrix
  end
